package com.sabbir.andorid.apps.myids;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==21){
            FirebaseUser firebaseUser= DumbApp.getInstance().getFirebaseUser();
            Toast.makeText(this,firebaseUser.getDisplayName(),Toast.LENGTH_LONG).show();
        }
    }
